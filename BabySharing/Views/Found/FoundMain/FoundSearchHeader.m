...
- (void)layoutSubviews {
    ...
    if (_headImg.image == nil) {
        ...
        _headLabell.center = CGPointMake(CGRectGetWidth(self.frame) / 2 - (CGRectGetWidth(self.frame) / 2 + 2 - (_headLabell.frame.size.width + 20) / 2), CGRectGetHeight(self.frame) / 2  + 10);
//        _headLabell.textColor = [UIColor colorWithRed:70.0 / 255.0 green:219.0 / 255.0 blue:202.0 / 255.0 alpha:1.0];
