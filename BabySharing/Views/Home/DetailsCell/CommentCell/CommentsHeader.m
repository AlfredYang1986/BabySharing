...
- (void)setUpSubviews {
    ...
    UIImageView* btn = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, BTN_WIDTH, BTN_HEIGHT)];
...
//    CALayer* al = [CALayer layer];
    ...
    btn.image = [UIImage imageNamed:[resourceBundle pathForResource:[NSString stringWithFormat:@"CommentHeader"] ofType:@"png"]];
