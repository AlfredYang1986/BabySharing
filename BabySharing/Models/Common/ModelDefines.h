...
#define POST_UN_LIKE                        [POST_HOST_DOMAIN stringByAppendingString:@"postUnlike"]
#define POST_UN_PUSH                        [POST_HOST_DOMAIN stringByAppendingString:@"postUnpush"]
...
#define USER_SCREEN_NAME_WITH_ID            [USER_SEARCH_HOST_DOMAIN stringByAppendingString:@"queryUserScreenWithId"]
