...
+ (ConnectionOwner*)createOrUpdateOwner:(NSString*)owner_id andFollowings:(NSArray*)following_arr andFollowed:(NSArray*)followed_arr inContext:(NSManagedObjectContext*)context {
    [self createOrUpdateOwner:owner_id andFollowed:followed_arr inContext:context];
    return [self createOrUpdateOwner:owner_id andFollowings:following_arr inContext:context];
}
...
+ (NSArray*)queryMutureFriendsWithOwner:(NSString*)owner_id inContext:(NSManagedObjectContext*)context {
    NSArray* followings = [self queryFollowingsWithOwner:owner_id inContext:context];
    NSArray* followed =  [self queryFollowedWithOwner:owner_id inContext:context];
    return followed;
}
@end
